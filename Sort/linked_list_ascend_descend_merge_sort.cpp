// Sort a linked list that is alternatively 
...
{ 
	...
	// Merge the two linked lists which are sorted in ascending order 
...
{ 
	...
	cout << "Given Linked List is (in alternate ascending and descending ordered elements): " << endl; 
	printlist(head); 
